...
export const lessonThaiTranslations = {
  "html/document-language-metadata": {
    ...
    title: "ข้อมูลพื้นฐานของหน้าเว็บควรอยู่ใน head",
    summary:
      "ใส่ข้อมูลสำคัญไว้ใน `head` เช่น `lang`, `charset`, `viewport` และ `title`. ข้อมูลเหล่านี้ช่วยให้ browser เข้าใจหน้าเว็บตั้งแต่เริ่มโหลด เช่น ใช้ภาษาอะไร รองรับขนาดหน้าจอแบบไหน และชื่อหน้าคืออะไร.",
