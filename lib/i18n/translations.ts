...
export const lessonThaiTranslations = {
  "html/document-language-metadata": {
    codeComments: {
      goodCode: ["ข้อมูลใน head บอกภาษาและขนาดหน้าจอก่อนแสดงผล"],
      badCode: ["ขาด lang และ viewport ทำให้ browser ต้องเดาภาษาและขนาดเอง"],
    },
    title: "ข้อมูลตั้งต้นของหน้าใน head",
    summary: "ใส่ `lang`, `charset`, `viewport` และ `title` เพื่อให้ browser รู้ภาษา ขนาดหน้าจอ และชื่อหน้าตั้งแต่เริ่มโหลด.",
    takeaways: ["ทุกหน้าควรมีข้อมูลตั้งต้นใน `<head>` เพราะ browser และเครื่องมือช่วยอ่านใช้ข้อมูลนี้ก่อนอ่านเนื้อหาใน body."],
    whatToReview: [
      "โค้ดที่ดีใส่ `lang`, `charset`, `viewport` และ `title` ไว้ใน `<head>` ของเอกสาร.",
      "โค้ดที่ควรปรับปล่อยให้ browser เดาภาษาและขนาดหน้าจอ ทำให้การแสดงผลหรือการอ่านออกเสียงคลาดจากเนื้อหาจริง.",
    ],
    reviewNotes: [
      "เวลารีวิว HTML ให้เริ่มจาก `<head>` ก่อน ถ้าข้อมูลตั้งต้นหายไป เนื้อหาใน body อาจอ่านถูกยากตั้งแต่ยังไม่ถึงส่วนที่ผู้ใช้เห็น.",
    ],
  },
  "html/semantic-document-structure": {
    codeComments: {
      goodCode: ["แท็ก main และ article บอกว่านี่คือเนื้อหาหลักและบทความ"],
      badCode: ["div ทั่วไปบอกไม่ได้ว่าส่วนนี้ทำหน้าที่อะไร"],
    },
    title: "เลือกแท็กให้บอกหน้าที่ของหน้า",
    summary: "ใช้ `main`, `nav`, `article` และ heading เพื่อให้ HTML บอกได้ว่าส่วนไหนคือเมนู เนื้อหาหลัก หรือบทความ.",
    ...
    whatToReview: [
      ...
      "โค้ดที่ควรปรับใช้ `div` หลายชั้นจนคนอ่านโค้ดและเครื่องมือช่วยอ่านไม่รู้หน้าที่ของแต่ละส่วน.",
    ],
    reviewNotes: [
  ...
  "html/heading-hierarchy": {
    ...
    title: "ลำดับ heading",
    summary: "ใช้ `h1` ถึง `h6` เพื่อบอกลำดับเนื้อหา ไม่ใช่เลือกตามขนาดตัวอักษรที่อยากให้แสดง.",
  ...
  "html/links-and-navigation": {
    ...
    summary: "ถ้าการกดพาผู้ใช้ไปหน้าอื่น ให้ใช้ `<a href>` และตั้งข้อความลิงก์ให้บอกปลายทาง.",
  ...
  "html/images-alt-text": {
    ...
    summary: "เขียน `alt` ให้รูปที่สื่อข้อมูล และใช้ `alt=\"\"` กับรูปที่มีไว้ตกแต่ง.",
  ...
  "html/accessible-form-labels": {
    codeComments: {
      goodCode: ["label และข้อความช่วยเหลือเชื่อมกับ input ผ่าน id เดียวกัน"],
      badCode: ["placeholder ไม่ใช่ชื่อ field ที่คงอยู่ตลอดเวลา"],
    },
    title: "ชื่อช่องกรอกที่ไม่หายตอนพิมพ์",
    summary: "ผูก `label` กับ `input` ด้วย `for` และ `id` แทนการใช้ placeholder เป็นชื่อช่องกรอก.",
  ...
  "html/form-help-errors": {
    ...
    summary: "ใช้ `aria-describedby` และ `aria-invalid` เพื่อผูกคำแนะนำกับ error เข้ากับช่องกรอกที่เกี่ยวข้อง.",
  ...
  "html/interactive-elements": {
    ...
    title: "ใช้ปุ่มจริงเมื่อเป็นการสั่งงาน",
    summary: "ถ้าผู้ใช้กดเพื่อสั่งงาน ให้ใช้ `button` หรือ element ที่ browser รองรับพฤติกรรมนั้นอยู่แล้ว.",
  ...
  "html/tables-tabular-data": {
    ...
    summary: "เมื่อข้อมูลเป็นแถวและคอลัมน์ ให้ใช้ `table`, `caption`, `th` และ `scope` เพื่อบอกหัวตารางกับค่าของแต่ละช่อง.",
  ...
  "html/aria-restraint": {
    ...
    summary: "เริ่มจากแท็ก HTML ที่มี role และพฤติกรรมของ browser ก่อน แล้วใช้ ARIA เฉพาะข้อมูลที่ HTML บอกเองไม่ได้.",
