...
**Track**:
A top-level learning category in the Example Library. Initial Tracks are HTML, CSS, JavaScript, TypeScript, and React; Track is used because not every category is a programming language.
_Avoid_: Language
...
Dev: "Should React be listed under languages?"
Domain expert: "No. Use Track for the top-level category so HTML, CSS, JavaScript, TypeScript, and React can sit together cleanly."
