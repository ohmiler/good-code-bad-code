...
In review, absence is part of the domain model. Optional and nullable describe different forms of absence, and mixing them casually makes every consumer repeat the same guessing game.
